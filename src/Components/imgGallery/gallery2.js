     ...
     return (
       ...
       <div className='gallery-container'>
            ...
            <div style={galleryStyle} className>
               {datosini2.map((img, index) => (
                    <div key={img.id}>
                    <ModalImage
                         small={process.env.PUBLIC_URL + "/imagenes/imgprimario/" + img.image}
                         large={process.env.PUBLIC_URL + "/imagenes/imgprimario/" + img.image}
                         alt={"Image " + img.id}
